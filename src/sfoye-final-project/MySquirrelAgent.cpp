...
namespace GMUCS425
{
	...
	void MySquirrelAgent::handle_event(SDL_Event & e)
	{
		const int delta = 5;
	...
	void MySquirrelAgent::move_to_next_waypoint()
	{
		const int delta = 2;
		...
		/*
		//check terrain, if the squirrel is in watery area, slow down
